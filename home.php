        ...
        <div class="container">
            <div class="row gx-5">
                <div class="col-lg-6 py-5">
                    <div class="py-5">
                        <h1 class="display-5 text-white mb-4">Welcome to RURAL HEALTH UNIT II </h1>
            ...
            <div class="bg-primary p-5">
                <form class="mx-auto" style="max-width: 600px;">
                    <div class="input-group">
                        <input type="text" class="form-control border-white p-3" placeholder="Don't have an account yet?">
                        <a class="btn btn-dark px-4" href="client/register.php">Sign Up</a>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row g-0">
                <div class="col-md-6 text-center text-md-start">
                    <p class="mb-md-0">&copy; <a class="text-white border-bottom" href="#">Rhums</a>. All Rights Reserved.</p>
                </div>
                <div class="col-md-6 text-center text-md-end">
                    <p class="mb-0">Designed by <a class="text-white border-bottom" href="https://htmlcodex.com">Team Fraxinus</a><br>
                        Distributed to <a class="text-white border-bottom" href="https://themewagon.com">RhuIIStoDomingo</a>          
                    </p>
                </div>
            </div>
        </div>
