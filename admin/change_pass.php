          ...
          <div class="card bg-secondary shadow border-0">
            ...
            <div class="card-body px-lg-5 py-lg-4">
              <div class="text-center text-dark mb-4">
                ...
                <p class="sub-text text-left mt-4">.</p>
              ...
              <form id="login-frm" action="" method="post">
                 ...
                 <div class="input-group mb-3">
                  ...
                  <input type="text" class="form-control" autofocus name="new_password" placeholder="Enter New Password" required>
                </div>
                 ...
                 <div class="input-group mb-3">
                  ...
                  <input type="text" class="form-control" autofocus name="c_password" placeholder="Confirm Password" required>
                </div>
