...
<div class="card card-outline card-primary">
	<div class="card-header">
		...
		<div class="card-tools">
			...
			<a class="edit_data btn btn-secondary" target="_blank" href="generate_pdfAB.php?id="> <span class="fa fa-file-pdf text-danger"></span> Generate PDF</a>
		</div>
								...
								<tbody>
								 ...
								 <button type="button" class="btn btn-flat btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  ...
				                  <div class="dropdown-menu" role="menu">
				                    <a class="dropdown-item view_data" href=<?php echo base_url ?>admin/?page=view-animalbite&viewid=<?php echo intval($row['pid']); ?>><span class="fa fa-search text-success"></span> View</a>

				                    <a class="dropdown-item view_data" href=<?php echo base_url ?>admin/?page=edit-animalbite&viewid=<?php echo intval($row['pid']); ?>><span class="fa fa-edit text-danger"></span> Update</a>
