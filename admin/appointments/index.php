								...
								<td><b>PA-<?php echo $row['id'] ?></td>
									...
									<td align="center">
										...
										<div class="dropdown-menu" role="menu">
											...
											<!-- <a class="dropdown-item edit_data" href="($reason == 'check up')?'add-check'<?php echo base_url ?>admin/?page=add-record&id=<?php echo $row['id'] ?>"> <span class="fa fa-file text-primary"></span> Add Record</a> -->
